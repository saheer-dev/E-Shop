...
export default function BestSeller() {
  ...
  return (
    <div className="w-[100] h-[30rem] mt-12 ">
      <h2 className="text-4xl pl-7">Special offers</h2>
      <div  id="img">
        <Splide
          options={{
            rewind: true,
        ...
        >
          {
          products.filter(a=>a.category=="electronics").map((e) => (
            <SplideSlide>
              <div className="relative overflow-hidden" id="op">
                <div className="h-[18rem] w-[22rem] overflow-hidden">
                <img
              ...
              <div id="show_div" className=" z-10 w-[21.9rem]  gap-3 absolute  top-[12rem] left-0 flex flex-col justify-end bg-slate-100">
